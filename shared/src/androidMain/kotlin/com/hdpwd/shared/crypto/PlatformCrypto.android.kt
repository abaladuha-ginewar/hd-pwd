...
/**
 * Android 使用 Diglol Crypto 的生产密码学提供者。
 */
actual fun platformCryptoProvider(): CryptoProvider = DiglolAndroidCryptoProvider()

/**
 * 通过 Argon2id 和 XChaCha20-Poly1305 实现 Android 密码学门面。
 */
private class DiglolAndroidCryptoProvider : CryptoProvider {
    /**
     * 生成密码学安全随机字节。
     */
