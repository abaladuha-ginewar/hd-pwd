...
object UserFacingText {
    ...
    private val ERROR_EXACT = mapOf(
        ...
        "加密容器 magic 无效" to "所选文件不是有效的 hd-pwd 备份",
        "加密容器长度不足" to "所选文件不是有效的 hd-pwd 备份",
        "加密容器头部长度无效" to "所选文件不是有效的 hd-pwd 备份",
        "加密容器头部不匹配" to "所选文件不是有效的 hd-pwd 备份",
    ...
    private val ERROR_CONTAINS = listOf(
        ...
        "加密容器 magic" to "所选文件不是有效的 hd-pwd 备份",
        "本机主密码错误" to "本机主密码错误",
